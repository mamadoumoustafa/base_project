package com.moustafa.syllas.service;
...
import com.moustafa.syllas.repository.AuthorityRepository;
import com.moustafa.syllas.repository.UserRepository;
import com.moustafa.syllas.security.AuthoritiesConstants;
...
public class UserService {
    ...
    public Mono<User> createUser(UserDTO userDTO) {
        ...
        user.setStructureId(userDTO.getStructureId());
        ...
        return Flux.fromIterable(userDTO.getAuthorities() != null ? userDTO.getAuthorities() : new HashSet<>())
            ...
            .publishOn(Schedulers.boundedElastic())
            .map(newUser -> {
                String clientSecret = RandomUtil.generatePassword();
    ...
    public Flux<UserDTO> getAllManagedUsersNotApp(Pageable pageable) {
        return userRepository.findAllByLoginNotAndApikeyNull(pageable, Constants.ANONYMOUS_USER).map(UserDTO::new);
    }
