package com.moustafa.syllas.web.rest.vm;

import com.moustafa.syllas.repository.UserRepository;
import com.moustafa.syllas.security.SecurityUtils;
import com.moustafa.syllas.service.EmailAlreadyUsedException;
import com.moustafa.syllas.service.MailService;
import com.moustafa.syllas.service.UserService;
import com.moustafa.syllas.service.dto.PasswordChangeDTO;
import com.moustafa.syllas.service.dto.UserDTO;
import com.moustafa.syllas.web.rest.errors.InvalidPasswordException;
...
public class AccountResource {
     ...
     * @throws com.moustafa.syllas.web.rest.errors.InvalidPasswordException {@code 400 (Bad Request)} if the password is incorrect.
     * @throws com.moustafa.syllas.service.EmailAlreadyUsedException {@code 400 (Bad Request)} if the email is already used.
     * @throws com.moustafa.syllas.web.rest.errors.LoginAlreadyUsedException {@code 400 (Bad Request)} if the login is already used.
     */
